...
<html lang="en">
    ...
    <body>
        ...
        <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light" style=" background-image: url('roomsimage/KitchenHead.jpg');">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="btn-group">
                                                ...
                                                <a href="AddToCart?productid=${p.productid}&page=Kitchen">
                                                    <button type="button" class="btn btn-sm btn-outline-secondary">Add to cart</button>
                                                </a>
                                                <a href="Description?productid=${p.productid}&page=Kitchen">
