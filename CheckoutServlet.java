...
public class CheckoutServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Customer cSession = (Customer) session.getAttribute("customer");
        ...
        if (editAddress != null) {
            ...
            Customer cust = cCtrl.findCustomer(cSession.getCustomerid());

            if (cust != null) {
                cust.setAddress(editAddress);
                ...
                request.setAttribute("msg", "<div class='alert alert-success' role='alert'> Change address successful </div>");
